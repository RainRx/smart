  ...
  <div v-clickoutside="hide" class="drop-down">
    ...
    <ul 
      ...
      <li
        ...
        <nuxt-link class="nav-item link-item" :to="{ name: item.name }">{{ item.title }}</nuxt-link>
      </li>
    </ul>
  </div>
</template>
...
export default {
  ...
  data () {
    return {
      ...
      title: '首页',
      items: [
        { name: 'index', title: 'Share View' },
        { name: 'books', title: 'Download' },
        { name: 'repos', title: 'More Info' },

  ...
  <div class="item" @click="download">
    ...
    <div class="info">
      ...
      <div class="other">
        ...
        <div class="messages">
          <span class="message">{{ item.createdAt }}</span>
          <span class="message read-duration">{{ Math.floor(item.contentSize/60/item.lastSectionCount) }}赞</span>
          <span class="message">{{ item.buyCount }}人已下载</span>
        </div>
      </div>
    </div>
    <div class="m-aside">

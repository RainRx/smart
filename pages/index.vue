  ...
  data () {
    return {
      categories: [
        ...
        { router: { path: '/welcome/frontend' }, title: '知识点提纲' },
        { router: { path: '/welcome/android' }, title: '平时作业' },
        { router: { path: '/welcome/backend' }, title: '期末考卷' },
        { router: { path: '/welcome/ai' }, title: '小组展示ppt' },
        { router: { path: '/welcome/ios' }, title: '课本电子档' },
        { router: { path: '/welcome/freebie' }, title: '学校官方表格' },
